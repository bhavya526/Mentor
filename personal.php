...
if(isset($_POST['next']))
{
				 ...
				 $_SESSION['semes']=$_POST['raal'];
				   ...
				   $up=mysqli_query($con,"update registration set Mobileno='$_POST[p1]' where RegistrationID='$takeeeee' ");
				   ...
				   $uptodate=mysqli_query($con,"update examform set cname='$_POST[c1]',fname='$_POST[f1]',
						 ...
						 medium='$_POST[oppk]',coursess='$_POST[qrt]',sems='$_POST[raal]' where RegistrationID='$takeeeee'");
				   if($uptodate)
				   {
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a href='personal.php'><img src='userimages/my1.jpeg' height=50,width=50 style='border:3px solid black;border-radius:32px;box-shadow: 0px 0px 0px 5px #cf805f;';></a>
...
&nbsp &nbsp &nbsp &nbsp &nbsp <a href='' style='color:white !important;font-weight:bold'>Documents</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
...
<tr style='background-color:#ffbc3b'>
	...
	<td colspan=2 style='color:black'><input type='radio' name='n1' <?php if($row[9]=="Indian") echo "checked";?> value='Indian'>&nbsp Indian
	  &nbsp &nbsp &nbsp  <input type='radio' name='n1' <?php if($row[9]=="Others") echo "checked";?>  value='Other' >&nbsp Other
		...
		<td colspan=2 align='left' style='color:red';><input type='text' required size=25 style='height:29px;' value='<?php echo $row[10];?>' name='p1' value='' size=25 maxlength=10></td>
