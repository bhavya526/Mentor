...
<a href='Qualification.php'><img src='userimages/my12.jpeg' height=50,width=50 style='border:3px solid black;border-radius:32px;box-shadow: 0px 0px 0px 5px #cf805f;';>
...
<br><br>
 &nbsp &nbsp &nbsp <a href='personal.php' style='color:white !important; font-weight:bold'>Personal Details</a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
	   ...
	   $_SESSION['obtained2']=$_POST['minni'];
        ...
        $con=mysqli_connect("localhost","root","","examport");
				   ...
				   $uptodate=mysqli_query($con,"update examform set tenpassyear='$_POST[eer]',board1='$_POST[bo]',
						 ...
						 obtained2='$_POST[minni]' where RegistrationID='$takeeeee'");
				   if($uptodate)
				   {
 ...
 <br>
	 ...
	 <td colspan=10></td>
				...
				<tr>
					  ...
					  <td align='left' style='color:red';>
					        <input readonly type='text' name='eer' value='<?php echo $row[30];?>' size=30 style='height:29px;'>
						</td>
	 ...
	 <td colspan=10></td>
                  ...
                  <tr>
						  ...
						  <td align='left' style='font-weight:Bold;color:black';>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Passing Year  :</td>
						 <td  align='left' style='color:red';>
					        <input readonly type='text' name='twk' value='<?php echo $row[37]; ?>' size=30 style='height:29px;'>
						</td>
