  ...
  <div style='width:100%;height:40px;background-color:#f5f5f5'>
   <a href="adminlogin.php" style='margin-left:1260px'>&nbsp LOG OUT </a>
	...
	<table cellspacing=0 cellpadding=10 style='background-color:#f5f5f5'>
		...
		<tr style='background-color:#efefef'><td width=200px><a href='regdetails.php'><img src='admin images/regicon.png' style='width:20px;height:20px'/>&nbsp Registration Details</td></td>
		<tr ><td width=200px style=''><a href='reglist.php'><img src='admin images/arrow.png' style='margin-left:40px;width:10px;height:10px'/>&nbsp List</td></td>
         ...
         $s=mysqli_query($con,"select * from registration");
	              ...
	              while($row=mysqli_fetch_array($s))
                 {
                    ...
                    echo "<td align='center'>$sno</td>";
                         ...
                         echo "<td><a href='details.php?a=$row[0]'><input type='button' style='background-color:blue; width:80px;
	                               height:30px;font-weight:bold;border:none;color:white' value='VIEW'></a></td>";  
  
                         echo "<td><a href='del.php?a=$row[0]'><img src='admin images/delete.png' width=25px height=25px style=';'></a></td>";
                         echo "</tr>";
                         $sno++;
					}
