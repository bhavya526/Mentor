...
<body>
 ...
 <div >
  ...
  <div class="">
   <div style='float:left'>
    <img src='userimages/ree.jpg' style='margin-left:120px;margin-top:80px;height:230px; width:380px'/>
     </div>
	 <div style='float:right;margin-right:300px;margin-top:90px'>
	   <form action="resultpdf.php" method='POST'>
		  ...
		  ?>
		   ...
		   <span style='border-bottom:1px solid black;border-bottom-style:dotted;font-weight:bold'><?php echo $a; ?>&nbsp <?php echo $b; ?> Examination Result 2020-21 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </span><span><br>
