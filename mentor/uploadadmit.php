...
<body>
  ...
  <div style='width:100%;height:40px;background-color:#f5f5f5'>
   <a href="adminlogin.php" style='margin-left:1260px'>&nbsp LOG OUT </a>
      <button type="button" id="btn1"  style='width:200px;FONT-WEIGHT:bold;margin-left:500px;background:linear-gradient(to right, #709BFE,#45BBFE);margin-top:3px;height:50px;focus:none;outline:none;border:none '>Upload Admit Cards</button>
	...
	<table cellspacing=0 cellpadding=10 style='background-color:#f5f5f5'>
		...
		<tr style='background-color:#efefef'><td width=200px><a href='uploadadmit.php'><img src='admin images/admitup.png' style='width:20px;height:25px'/>&nbsp Upload Admit Cards</td></td>
   ...
   <script>
		...
		$(document).ready(function()
		{
		   ...
		   {
		   var id=$(this).attr("id");
		     $.post("carddelete.php",{ids:id},function(data)
			 {
			   $("#blue").html(data).show();
			   return false;
			 });
		   ...
		   $("#meclick").click(function()
		   {
			 ...
			 $.post("getupload.php",{course:course,degree:degree,year:year},function(data)
			 {
			   $("#su").html(data).show();
			   return false;
			 });
	...
	<div style='margin-top:-400px;float:right; width:80%'>
		 ...
		 <div id="green" style='display:none;width:100%;height:100%;margin-top:-100px'>
	  <form action="" method="POST" >
		 <select name='year' id="year" style="width:220px;margin-left:80px;height:30px;font-weight:bold;" >
...
<br><br>
	...
	<div id="blue" style='display:none;width:100%;height:100%;;margin-top:-180px'>
	    <?php
