  ...
  <main id="main">
    ...
    <section id="contact" class="contact" style='background-color:#f6fcf8 !important;height:auto'>
      ...
      <div class="container"  >
		 ...
		 ;margin-right:-116px;margin-top:-50px '>
	  ...
	  <br>
			...
			<div style='' >
               ...
               <div style='' >
			     ...
			     <table center='align' rules='none' border=3 cellspacing=0  cellpadding=10 width=1200px style='margin-left:-70px;margin-top:-30px;border-left:1pt solid white;border-right:1pt solid white'>
                     ...
                     <?php
                          ...
                          //       $id=$_SESSION["idd"];
                                 ...
                                 $r=mysqli_query($con,"select * from examform where lastsemroll='$semroll'");
				   ...
				   <tr>
					 ...
					 <input type='text' value='<?php echo $row[52] ?>' name='app' style='display:none'>
					  <tr >
					    <td colspan=3 align='center'><input type='submit' value='Download Examination Form' name='download' formaction="examinationform2.php" style='color:white;background:#3575D3;font-weight:bold;height:28px'>
						<input type='submit' value='Download Challan' name='download1' formaction="challan2.php" style='color:white;background:#3575D3;font-weight:bold;height:28px'>
						</td>
					 </tr>
