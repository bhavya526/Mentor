      ...
      <table border=1 style='border-style:dotted' width=700px cellpadding=10 cellspacing=0 align='center'>
	      <tr style='border-bottom-color:#e7f8ec'>
		     <td style='height:auto'>
			    <img src='userimages/admitfin.jpg' style='width:100%;height:90px'>
		     </td>
		  </tr>
		  ...
		  <tr style='border-top-color:#e7f8ec;'>
		     <td >
			      <?php
			                      ...
			                      $r=mysqli_query($con,"select * from admitcards ORDER BY Sno DESC");
	                            ...
	                            while($row=mysqli_fetch_array($r))
			                     {
			                        ...
			                        echo "  <li><a href='application.php?ai=$row[2]&b=$row[3]' style='color:blue;;margin-left:20px'> $row[1]</a></li><br>";
