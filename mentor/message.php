  ...
  <div style='width:100%;height:40px;background-color:#f5f5f5'>
   <a href="adminlogin.php" style='margin-left:1260px'>&nbsp LOG OUT </a>
    ...
    echo "
	   ...
	   {
             echo "<td align='right'>
			           <a href='queryreply.php?a=$row[0]'><input type='button' style='background-color:#2832C2; width:100px;
	                               height:30px;font-weight:bold;border:none;color:white' value='REPLY'></a>
				   </td>";  
         }
		 else
	   {
             echo "<td align='right'><a href='queryreplied.php?a=$row[0]'><input type='button' style='background-color:#4CBB17; width:100px;
	                               height:30px;font-weight:bold;border:none;color:white' value='REPLIED'></a>
				   </td>";  
		 }
              echo "<td align='center'><a href='contactdel.php?a=$row[0]'><img src='admin images/delete.png' width=25px height=25px style=';'></a>
			        </td>";
               echo "</tr>";
                         $sno++;
