...
<?php
	 ...
	 $r=mysqli_query($con,"select * from teacherlogininfo where username='$user' and password='$pass'");
	  if($row=mysqli_fetch_array($r))
	  {
	     $_SESSION['userteach']=$_POST['au1'];
		 $_SESSION['degreeteach']=$row[4];
		 $_SESSION['courseteach']=$row[5];
		 $_SESSION['subteach']=$row[6];
		 $_SESSION['subcode']=$row[7];
