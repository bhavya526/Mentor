...
<body>
 ...
 <div >
  ...
  <div class="">
   <div style='float:left'>
    <img src='userimages/adm.gif' style='margin-left:120px;margin-top:80px;height:230px; width:400px'/>
     </div>
	 <div style='float:right' style=';margin-right:300px;margin-top:90px'>
	   <form action='getadmitfinal.php' method="POST">
	      <?php
		    $a=$_REQUEST["ai"];
		    $b=$_REQUEST["b"];
	 ...
	 <table cellspacing=0 cellpadding=10 width=300px style='margin-top:90px;margin-right:300px' >
	            
	            <tr><td align='center' style='font-weight:bold'>Enter the information</td></tr>	  
			    
				<tr><td><input type='text' required size=40 value='' name='app' placeholder='Application No.' style='height:40px'></td></tr>
			     <tr><td align='center'> <input type='submit' name='give' value='Get Admit Card'></td></tr>
			  </table>
			</form>
