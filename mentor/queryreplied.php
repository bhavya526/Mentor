...
<body>
  ...
  <div style='width:100%;height:40px;background-color:#f5f5f5'>
	...
	<div style='margin-top:-450px;float:right; width:80%'>
	     <?php
       $id=$_REQUEST["a"];
...
<div style='float:left;margin-left:40px;margin-top:-127px;color:black;font-weight:bold'>
<form action="" method="POST" >
   Name:   <input type='text' disabled value='<?php echo $row[1]; ?>' style='width:479px;height:70px;border:1px solid black; margin-left:100px;border-color:#D3D3D3;padding:10px'> <br><br>
	 E-Mail:<input type='text' disabled value='<?php echo $row[2]; ?>' style='width:479px;height:70px;border:1px solid black; margin-left:101px;border-color:#D3D3D3;padding:10px'><br><br>
	 Message/Query:<input type='text' disabled value='<?php echo $row[3]; ?>' style='width:479px;height:70px;border:1px solid black;margin-left:24px; border-color:#D3D3D3;padding:10px'><br><br>
         <input type='text' value='<?php echo $row[4]; ?>' style='width:479px;height:70px;border:1px solid black; border-color:#D3D3D3;margin-left:152px;padding:10px' disabled>
	<br><br>
	<input type='submit' value='OK' name='repll' style='margin-left:530px;width:80px;height:30px;background-color:#5FCF80;border:none;font-size:15px;font-family:Arial Black'>
