	  ...
	  <br>
	   ...
	   <br>
			...
			<?php
             ...
             <table border=1 align='center' rules='none' cellspacing=0 cellpadding=5 width=360px height=400px style='background-color:white'>
                  ...
                  {   
                      ...
                      $r=mysqli_query($con,"update examform SET Holder='$_POST[card1]', Cardnum='$_POST[card2]'
					      where lastsemroll=$semroll");
				  ...
				  <tr height=50px style='background-color:#bbbbbb'><td style='font-weight:bold;color:#500000 ;border-bottom: 2pt solid black ;;width:180px;font-size:16px'>Credit & Debit cards</td>
                       <td style='width:60px;'><img src="userimages/card1.jpeg" height=30px width=50px ></td>
                       <td style='width:60px'><img src="userimages/card2.jpeg" height=30px width=50px ></td>
                       <td style='width:60px'><img src="userimages/card3.jpeg" height=30px width=50px></td>
					</tr>
					...
					<tr><td colspan=4 style='color:black;font-weight:bold'>&nbsp Cardholder Name</td></tr>
					 ...
					 <tr><td colspan=2> &nbsp 
						  ...
						  <tr>
						     <td colspan=4 align='center'><input type='submit' name='moove' value='Pay  Rs.1950/-' style='height:30px;width:340px; color:white;background-color:#3575D3;font-weight:bold'>
						  </tr>
						  <tr><td colspan=4></td></tr>
						  <tr><td colspan=4></td></tr>
