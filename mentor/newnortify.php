 ...
 <header id="header" class="fixed-top" style=';;margin-top:3px;height:5px;background-color:rgba(0,0,0,0)'>
  ...
  <style>
	...
	<table cellspacing=0 cellpadding=10 style='background-color:#f5f5f5'>
		...
		<tr style='background-color:#efefef'><td width=200px><a href='newnortify.php'><img src='admin images/bell.png' style='width:20px;height:20px'/>&nbsp Notifications</td></td>
		<tr ><td width=200px style=''><a href='delnortify.php'><img src='admin images/arrow.png' style='margin-left:40px;width:10px;height:10px'/>&nbsp Delete</td></td>
	...
	<div>
	<div style='float:center;margin-left:620px;'>
	  <br><br>
	  <?php
	  if(isset($_POST["add"]))
	  {
          ...
          $query=mysqli_query($con,"insert into norifications (title) value('$title') ");
		  
		  if($query)
		  {
		     
			 echo "<span style='color:red;margin-left:610px;font-weight:bold'>ADDED</span>";
		  }
		  
	  }
	  ?>
	  <form method='POST'>
	  <span style='margin-left:100px;font-weight:bold;' >Add here</span>
	   <br><br>
	   <select name='select' required style='width:280px;height:30px'>
	       <option  disabled selected hidden  >Type</option>
	      <option value='General'>General</option>
		  <option value='Examination'>Examination</option>
	   </select><br><br>
	   <textarea style='width:280px' required  value='' placeholder='Title' name='title'></textarea>
	   <br><br>
	   <input type='submit' value='Add' name='add' style='width:60px;margin-left:110px' >
	   </form>
	   </div>
	</div>
