      ...
      <table border=1 style='border-style:dotted' width=700px cellpadding=10 cellspacing=0 align='center'>
	      <tr style='border-bottom-color:#e7f8ec'>
		     <td style='height:auto'>
			    <img src='userimages/examalert.jpg' style='width:100%;height:90px'>
		     </td>
		  </tr>
		  <tr>
		     <td style='color:red;font-family:calibiri'>
			    <span style='margin-left:410px'>Released Date</span><span style='margin-left:50px'>Last Date</span>
			 </td>
		  </tr>
		  <tr style='border-top-color:#e7f8ec;'>
		     <td >
			       <?php
								...
								echo "<ul>";
								$today=date("Y-m-d");
								echo "<table style='margin-top:-120px'>";
	                            while($row=mysqli_fetch_array($r))
			                     {
								    ...
								    if($today<$date)
									{
								    echo "<tr><td><p style='display:none'>$row[2]</p>";
			                        echo "&nbsp <li><a href='login.php?a=$row[2]' style='color:blue;;margin-left:20px'> $row[1]</a></td><td><span style='margin-left:110px;font-size:14px'>$row[4]</span></td><td><span style='margin-left:50px;font-size:14px'>$row[5]</span></td></tr></li><br>";
	                                 }
								   }
								   echo "</table></ul>";
								   echo "<br>";
