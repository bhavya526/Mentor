      ...
      <table border=1 style='border-style:dotted' width=700px cellpadding=10 cellspacing=0 align='center'>
	      <tr style='border-bottom-color:#e7f8ec'>
		     <td style='height:auto'>
			    <img src='userimages/reevaluate.jpg' style='width:100%;height:90px'>
		     </td>
		  </tr>
		  ...
		  <tr style='border-top-color:#e7f8ec;'>
		     <td >
			      <?php
			                      ...
			                      $r=mysqli_query($con,"select * from evaluation ORDER BY id DESC");
	 
	                            echo "<br>";
								echo "<ul>";
	                            while($row=mysqli_fetch_array($r))
			                     {
								    echo "<p style='display:none'>$row[3]</p>";
			                        echo "  <li><a href='puteval.php?ai=$row[2]&b=$row[3]' style='color:blue;;margin-left:20px'> $row[1]</a></li><br>";
