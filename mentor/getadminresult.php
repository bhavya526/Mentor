...
<body>
  ...
  <div style='width:100%;height:40px;background-color:#f5f5f5'>
   ...
   $rs=mysqli_query($con,"select * from result where Id='$id'");
 ...
 <table  width=720  cellspacing=0 cellpadding=10 style=''>
		              ...
		              <tr><td colspan=6 style='font-size:13px;BORDER:NONE'><span style='margin-left:57px;color:black'>Accredited with 'A' Grade by NAAC</span></td></tr>
					   ...
					   <tr><td COLSPAN=8 ALIGN='CENTER' style='border:none;font-weight:bold;FONT-SIZE:16PX;;color:blackfont-family:calibri'><?php echo $rps[7] ?>&nbsp <?php echo $rps[8] ?> CBCS EXAMINATION <?php echo $rps[9] ?>  </td></tr>
						 ...
						 <tr>
						   ...
						   <td align='right' colspan=8  style=';font-size:14px;font-weight:bold;height:40px;border:none;border-bottom:1px solid black;color:black' >&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp CONTROLLER OF EXAMINATION</td>
