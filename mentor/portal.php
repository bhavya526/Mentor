...
<div style='width:100%;height:50px;background-color:#eceff2;MARGIN-TOP:-5PX;'>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container"  >
		 ...
		 <div style=';height:auto;;margin-left:-250px 
   ...
   <br><br>
   <div style='height:auto;margin-left:70px;width:100%; '>
      <table border=1 style='border-style:dotted' width=700px cellpadding=10 cellspacing=0 align='center'>
	      <tr style='border-bottom-color:#e7f8ec'>
		     <td style='height:auto'>
			    <img src='userimages/whats.jpeg' style='width:100%;height:90px'>
		     </td>
		  </tr>
		  ...
		  <tr style='border-top-color:#e7f8ec;'>
		     <td >
			       <?php
	                            ...
	                            echo "<br>";
								echo "<ul><marquee direction=up SCROLLDELAY=200>";
	                            while($row=mysqli_fetch_array($r))
			                     {
			                        echo "  <li><p style='color:black;;margin-left:20px'> $row[1]</p></li>";
	                               }
								   echo "</marquee></ul>";
								   echo "<br>";
	                            ?>  
