...
<a href='Doc.php'><img src='userimages/mii.jpg' height=50,width=50 style='border:3px solid black;border-radius:32px;box-shadow:0px 0px 0px 5px #cf805f;';>
<img src='userimages/line2.png' height=50,width=50 style='width:150px';>
...
&nbsp &nbsp &nbsp &nbsp &nbsp <a href='Doc.php' style='color:white !important; font-weight:bold'>Documents</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
...
<?php
   ...
   $id=$_SESSION["idd"];
   $takeeeee=$_SESSION["displayregID"];
     $sql = "SELECT * from examform  WHERE RegistrationID='$takeeeee' ";
   ...
   if(isset($_POST['savee']))
   {
				   ...
				   sheetmark='$sheetmark' where RegistrationID='$takeeeee'");
                   
				  	

                   $upda=mysqli_query($con,"update registration SET TillDocumentsformstatus='Saved' where id='$id'");
				   if($r)
				   {
