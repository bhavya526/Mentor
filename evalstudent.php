...
<body>
  ...
  <div style='width:100%;height:40px;background-color:#f5f5f5'>
	...
	<table cellspacing=0 cellpadding=10 style='background-color:#f5f5f5'>
		...
		<tr style='background-color:#efefef'><td width=200px><a href='evalstudent.php'><img src='admin images/eval.jpg' style='width:20px;height:20px'/>&nbsp Eval List</td></td>
...
if(isset($_POST["geTY"]))
	  {
            $geki=$_POST['deg11'];
			 $kiel=$_POST['sem11'];
			 $uki=$_POST['ses11'];
			  echo "<table id='content' rules='none' align='center' width=720px style='margin-left:98px' cellspacing=0 cellpadding=10>";
			 echo "<tr style='border-bottom:1pt solid black;font-size:16px;color:black'>
			           <td align='center' style='font-weight:bold'>S.No</td>
			           <td align='center' style='font-weight:bold'>Roll No.</td>
					   ...
					   <td align='center' style='font-weight:bold'>Subjects</td></tr>";
					   
			 $con=mysqli_connect("localhost","root","","examport");
			 $r=mysqli_query($con,"select * from reevallist where course = '$geki' and sem='$kiel' and year='$uki' and status='Paid'");
		    ...
		    while($row=mysqli_fetch_array($r))
			{
			   ...
			   echo "<tr style='border-bottom:1pt solid black;color:black'>
					 ...
					 <td align='center'>$row[6]<br>$row[7]<br>$row[8]<br>$row[9]<br>$row[10]<br>$row[11]</td></tr>";
					 $sno++;
	   ...
	   {
	         $con=mysqli_connect("localhost","root","","examport");
			 $r=mysqli_query($con,"select * from reevallist where status='Paid'");
			 
			 echo "<table id='content' rules='none' align='center' width=720px style='' cellspacing=0 cellpadding=10>";
			 echo "<tr style='border-bottom:2pt solid black;color:black'>
			           <td align='center' style='font-weight:bold'>S.No</td>
			           <td align='center' style='font-weight:bold'>Roll No.</td>
					   <td align='center' style='font-weight:bold'>Student Name</td>
					   <td align='center' style='font-weight:bold'>Course</td>
